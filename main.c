...
O que ainda falta:
1 - Fazer a operação de "venda" por unidades;
2 - Ordenar livros por quantidade de paginas (opcional);
*/
int main(){
    ...
    do{
          ...
          printf("\nEscolha uma opcao:\n"
            "1 - Cadastrar livro\n"
            "2 - Lista de livros\n"
            "3 - Comprar um livro(NAO TERMINADA)\n"
            "4 - Remover um livro\n"
            "5 - Editar livro\n"
          ...
          switch (opcao){
            ...
            case 3:
                ...
                //condicaoCompra(&lista, nome, price, und);
